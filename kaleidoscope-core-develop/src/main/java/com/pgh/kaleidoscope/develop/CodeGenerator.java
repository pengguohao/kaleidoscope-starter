...
public class CodeGenerator {
	 ...
	 * 代码所在服务名
	 */
	public static String SERVICE_NAME = "kaleidoscope-system";
	/**
	 * 代码生成的包名
	 */
	public static String PACKAGE_NAME = "com.pgh.kaleidoscope.system";
	/**
	 * 前端代码生成所属系统
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	public static String[] TABLE_PREFIX = {"kaleidoscope_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	public static String[] INCLUDE_TABLES = {"kaleidoscope_client"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
