...
public class KaleidoscopeCodeGenerator {
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "kaleidoscope-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "com.pgh.kaleidoscope.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"kaleidoscope_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"kaleidoscope_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		...
		if (hasSuperEntity) {
			strategy.setSuperEntityClass("com.pgh.kaleidoscope.core.mp.base.BaseEntity");
			strategy.setSuperEntityColumns(superEntityColumns);
			strategy.setSuperServiceClass("com.pgh.kaleidoscope.core.mp.base.BaseService");
			strategy.setSuperServiceImplClass("com.pgh.kaleidoscope.core.mp.base.BaseServiceImpl");
		} else {
			strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
			strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
		}
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.pgh.kaleidoscope.core.boot.ctrl.BladeController");
